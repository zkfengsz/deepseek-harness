...
import appControllerRemote from '@deepseek-ai/dsh-api-app-controller/remote'
import mcpControllerRemote from '@deepseek-ai/dsh-api-mcp-controller/remote'
...
export type {} from '@deepseek-ai/dsh-api-app-controller/remote'
export type * from '@deepseek-ai/dsh-api-app-controller/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      subagentsRemote, sessionRemote, workspaceRemote, workspaceFilesRemote, appControllerRemote, mcpControllerRemote,
    ]) {
