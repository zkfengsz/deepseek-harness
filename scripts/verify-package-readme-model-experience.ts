...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-home': { kind: 'indirect', reason: 'Browser-side application portal; the preset and session it launches own every model-facing effect.' },
  'packages/client/ui-mcp-servers': { kind: 'none', reason: 'Browser-side MCP server settings; it registers no prompt, tool, or session event.' },
  'packages/client/ui-brand-workbro': { kind: 'none', reason: 'Browser-side brand marks and name; it registers nothing model-facing.' },
  ...
  'packages/mcp/mcp-manager': { kind: 'indirect', reason: 'The tools it registers come from the connected MCP servers, which own their model-visible definitions.' },
  'packages/skill/workbro-skills': { kind: 'indirect', reason: 'The embedded catalog delegates model rendering to dsh-tool-skill.' },
  'packages/app/app-registry': { kind: 'none', reason: 'Durable application records and their order; it registers no prompt, tool, or session event.' },
  'packages/mcp/mcp-registry': { kind: 'none', reason: 'Durable MCP server records and their order; it registers no prompt, tool, or session event.' },
  ...
  'packages/api/app-controller': { kind: 'none', reason: 'Application API owner; it registers no prompt, tool, or session event.' },
  'packages/api/mcp-controller': { kind: 'none', reason: 'MCP server API owner; it registers no prompt, tool, or session event.' },
