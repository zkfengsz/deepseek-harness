...
- `@deepseek-ai/dsh-api-app-controller` — 需要 `typert` · `appRegistry`（[`packages/api/app-controller/src/index.ts`](../packages/api/app-controller/src/index.ts)）
...
- `@deepseek-ai/dsh-app-registry` — 需要 `storageDomain`（[`packages/app/app-registry/src/index.ts`](../packages/app/app-registry/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-brand-workbro`（[`packages/client/ui-brand-workbro/src/index.ts`](../packages/client/ui-brand-workbro/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-home`（[`packages/client/ui-home/src/index.ts`](../packages/client/ui-home/src/index.ts)）
